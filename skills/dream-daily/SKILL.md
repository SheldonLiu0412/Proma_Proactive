...
|---------|---------|-------------|
| 任务痕迹 | 推进了什么、卡住了什么、没做完什么 | 未完成 +0.3，已闭环 -0.2 |
| 情绪痕迹 | 对话中的情绪信号（纠正、赞扬、急促、反复修改） | 强情绪 +0.3 |
| 人物痕迹 | 协作关系中的角色感受 | 冲突/亲密 +0.2 |
| 目标痕迹 | 反复追逐的东西、长期项目进展 | 与长期目标相关 +0.2 |
| 冲突痕迹 | 想做但没做到、决定了却没落地 | 矛盾/悬念 +0.2 |
| 新奇痕迹 | 第一次出现的概念、意外发现 | 异常新奇 +0.2 |
...
**核心要求：梦要像一个能读懂的故事。** 读者应该能被吸引着读下去，能感受到其中的情绪张力，读完后隐约觉得"这和白天的什么有关"但又说不清。不是碎片意象拼贴，而是一段有主线、有节奏、有余味的叙事。

**三幕叙事结构**：

1. **进入**：用具体的感官细节把读者拉进一个场景。"我"带着某种模糊的目的出现——在找什么、在赶去哪里、在等什么人。这个目的来自 salience 最高的残留，但不要直说，而是通过行动和环境暗示
2. **展开**：主线向前推进，但过程中不断偏移——路变了、人变了、手里的东西变了。其他残留的意象在这里自然地嫁接进来（不是硬切场景，而是"走着走着发现周围变了"）。**这一幕要有事情在发生**——对话、动作、选择、遭遇——不只是描写风景
3. **悬停/释放**：不需要完整结局。可以是快到了但醒来、某个画面突然安静下来、或者"我"接受了某种不确定就停在那里。留下余味，让读者自己去感受

**分镜之间有情绪弧线**：渐强、转折、或沉降——不是并列的独立片段。

**生成原则**：

1. **讲故事，不要堆意象**：每个分镜里要有"我"在做事、在经历，不只是"我看到了什么"。有动作、有遭遇、有微妙的对话
2. **象征化但可感知**：读者不需要完全理解每个符号的含义，但应该能感受到情绪——焦虑、温暖、悬而未决、差一点就够到。好的象征是"读不懂但读得到"
3. **禁止复述现实**：不能出现"今天""用户""我在处理某个任务"等映射现实协作的表述。白天的事件只通过结构和情绪渗入梦中
4. **体验者视角**："我"只经历和感受，不分析不解释不总结
5. **具体胜于抽象**：写"门把手是温的"而不是"感受到一种温暖"。写"数字 630 被谁用红笔圈了出来"而不是"精确性的执念"

**文风**：安静、具体、可感。像村上春树或卡尔维诺的梦境片段——读起来很日常，但越想越不对劲。300-600 字。
...
我好像在等一班车。站台上没有别人，但时刻表上的字一直在变——先是出发时间往后推了十分钟，然后车次号变成了一串我没见过的编码。我掏出手机想查，发现屏幕上显示的不是地图，而是一段我昨天写过的文字，只是每个句子的主语都被替换成了陌生人的名字。

远处有列车的光，越来越近。我能感觉到铁轨在震动，但车到了站台前却没有停——它从我面前滑过去的时候，车窗里有个人正在专注地调一个窗户的尺寸，用的尺子特别长，从车厢这头拉到那头。

---

> 室内 · 走廊 · 微光

我走进一栋楼。走廊比我预期的长得多，每扇门都半开着。我推开最近的一扇——里面是一间空房间，墙上挂着一面镜子。镜子里的我正在翻一本笔记本，笔记本里画满了流程图，但每条线都指向同一个框：「见下页」。我翻了一页，还是「见下页」。

走廊尽头传来打字声。我知道那是谁，但名字在嘴边就是说不出来。

---

> 黎明 · 窗边 · 静

我站在一扇很大的窗前。外面的光刚够看清轮廓。窗台上放着一杯已经凉了的茶，旁边有一张便签，上面只写了一个数字，但墨水洇开了，看不清是几。

我端起茶喝了一口。凉的，但不难喝。
```

注意示例中的特点：有"我"在做事（查手机、推门、翻笔记本、喝茶），有具体细节（数字、尺子、便签），有隐约的主线（在找/在等什么），分镜间有自然的场景过渡，情绪从焦虑到好奇到平静。
